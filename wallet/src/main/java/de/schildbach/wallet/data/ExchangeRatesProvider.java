...
public class ExchangeRatesProvider extends ContentProvider {
    ...
    private static final HttpUrl BITCOINAVERAGE_DASHBTC_URL = HttpUrl.parse("https://apiv2.bitcoinaverage.com/indices/crypto/ticker/SAFEBTC");
     ...
     private Map<String, ExchangeRate> requestExchangeRates() {
         ...
         try {
             ...
             if (dashPerBTC == null) {
                 ...
                 dashPerBTC = Double.parseDouble(dashRates.get("SAFE").rate.fiat.toString()) / Double.parseDouble(dashRates.get("SAFE").rate.coin.toString());
             }
         }
         catch(Exception x)
         {
