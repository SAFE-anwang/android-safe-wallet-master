...
public class PaymentProtocol {
    ...
    public static final String MIMETYPE_PAYMENTREQUEST = "application/safe-paymentrequest";
    public static final String MIMETYPE_PAYMENT = "application/safe-payment";
    public static final String MIMETYPE_PAYMENTACK = "application/safe-paymentack";
