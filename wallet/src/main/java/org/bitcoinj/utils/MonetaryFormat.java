...
public final class MonetaryFormat {
    ...
    public static final String CODE_BTC = "SAFE";
    /** Currency code for base 1/1000 Bitcoin. */
    public static final String CODE_MBTC = "mSAFE";
    /** Currency code for base 1/1000000 Bitcoin. */
    public static final String CODE_UBTC = "µSAFE";
    ...
    public Coin parse(String str, long decimals) throws NumberFormatException {
        return Coin.valueOf(parseValue(str, (int)decimals));
    }
