...
public class InsufficientMoneyException extends Exception {
    ...
    public boolean useInstantOutTooMax = false;

    public boolean useInstantInTooMax = false;

    public boolean useTxLimit = false;
    ...
    public InsufficientMoneyException(Coin missing, boolean useInstantOutTooMax, boolean useInstantInTooMax) {
        this(missing);
        this.useInstantOutTooMax = useInstantOutTooMax;
        this.useInstantInTooMax = useInstantInTooMax;
    }

    public InsufficientMoneyException(Coin missing, boolean useInstantOutTooMax, boolean useInstantInTooMax, boolean useTxLimit) {
        this(missing);
        this.useInstantOutTooMax = useInstantOutTooMax;
        this.useInstantInTooMax = useInstantInTooMax;
        this.useTxLimit = useTxLimit;
    }
