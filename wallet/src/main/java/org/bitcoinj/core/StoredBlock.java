...
public class StoredBlock {
    ...
    public boolean moreWorkThan(StoredBlock other) {
        if (height >= Constants.NETWORK_PARAMETERS.getSposStartDeterministicMasternodeHeight()) {
            return height - other.height > 0;
        } else if (height >= Constants.NETWORK_PARAMETERS.getStartSposHeight()) {
