...
public abstract class ChildMessage extends Message {
    ...
    public ChildMessage(NetworkParameters params, byte[] payload, int offset, @Nullable Message parent, MessageSerializer setSerializer, int length, long version)
            throws ProtocolException {
        super(params, payload, offset, setSerializer, length, version);
        this.parent = parent;
    }
