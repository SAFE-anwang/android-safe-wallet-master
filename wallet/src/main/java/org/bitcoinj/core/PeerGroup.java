...
//                    if (SafeConstant.getLastBlockHeight() >= Constants.NETWORK_PARAMETERS.getSposForbidOldVersionHeightV2()) {
//                        if (peer.getPeerVersionMessage().subVer.equals("/Safe Core:2.6.0/") || peer.getPeerVersionMessage().subVer.equals("/Safe Core:2.6.1/")) {
//                            handlePeerDeath(peer, null);
//                        } else {
//                            handleNewPeer(peer);
//                        }
